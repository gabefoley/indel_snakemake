...
if not os.path.isdir(f'fastml_results_parsimony/{taxon_num}/concatenated/'):
	os.mkdir(f'fastml_results_parsimony/{taxon_num}/concatenated/')
...
if not os.path.isdir(f'fastml_results_parsimony/{taxon_num}/concatenated/{rep}'):
	os.mkdir(f'fastml_results_parsimony/{taxon_num}/concatenated/{rep}')

if not os.path.isdir(f'fastml_results_ml/{taxon_num}/concatenated/{rep}'):
	os.mkdir(f'fastml_results_ml/{taxon_num}/concatenated/{rep}')


# with open(f'fastml_results/{taxon_num}/concatenated/{rep}/FastML_ancestors.fasta', 'w') as cleaned_aln:
with open({smakemake.output.aln}, 'w') as cleaned_aln:
...
if not os.path.isdir(f'fastml_results_parsimony/{taxon_num}/cleaned_trees/{rep}/'):
	print ('lets make it')
	os.mkdir(f'fastml_results_parsimony/{taxon_num}/cleaned_trees/{rep}/')

if not os.path.isdir(f'fastml_results_ml/{taxon_num}/cleaned_trees/{rep}/'):
	print ('lets make it')
	os.mkdir(f'fastml_results_ml/{taxon_num}/cleaned_trees/{rep}/')
